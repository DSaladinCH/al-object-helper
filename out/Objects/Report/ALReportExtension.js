...
exports.ALReportExtension = void 0;
const internal_1 = require("../../internal");
class ALReportExtension extends internal_1.ALExtension {
    constructor(objectPath, objectID, objectName, alApp) {
        super(objectPath, internal_1.ObjectType.ReportExtension, objectID, objectName, alApp);
    }
    setTempParentObjectFromType(objectName) {
        this.parent = new internal_1.ALReport('', '', objectName, internal_1.ALApp.Empty());
    }
    getUIDescription() {
...
exports.ALReportExtension = ALReportExtension;
//# sourceMappingURL=ALReportExtension.js.map